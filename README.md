...
datos en formato csv es muy sencillo. He desarrollado una clase Reports.py, donde se encuentran tres metodos, cada metodo genera un reporte. La clase Reports
se encuentra en una carpeta llamada Classes. Luego he usado el frameword de Django, donde 
